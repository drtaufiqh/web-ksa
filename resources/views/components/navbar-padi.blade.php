 ...
 <!-- Navbar -->
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          <a class="navbar-brand brand-logo" href="/"><img src="/assets/img/logo-full.png" alt="logo" /></a>
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                <h6 class="p-3 mb-0">Mode</h6>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item" style="background:linear-gradient(to right, #dffdc5, #feffd8)" href="/">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('padi_dashboard') }}">
                <span class="menu-title">Dashboard</span>
                <i class="fa fa-home"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('padi_petugas') }}">
                <span class="menu-title">Petugas</span>
                <i class="fa fa-users"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('padi_kondef') }}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('padi_unggah') }}">Unggah</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('padi_riwayat') }}">Riwayat</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('padi_validasi') }}">
                <span class="menu-title">Validasi</span>
                <i class="fa fa-list-alt"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('padi_panduan') }}">
