    ...
    <div class="container-scroller">
        ...
        <div class="main-panel">
            <div class="content-wrapper" style="background: linear-gradient(to right, #f4ffc8, #ddf3ca);">
                ...
                <div class="col-6" id="kanan">
                    <div class="page-header" style="background-color: #3b5740">
                        <h3 class="page-title"> Unggah Feedback </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="myForm2" action="{{ route('jagungamatan.upfeedback') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="tahun_fb">Tahun</label>
                                            <select name="tahun_fb" class="form-control" id="tahun_fb">
                                                @foreach($years as $year)
                                                    <option value="{{ $year }}">{{ $year }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="bulan_fb">Bulan</label>
                                            <select class="form-control" id="bulan_fb" name="bulan_fb">
                                                <option value="01" {{ $currentMonth == '01' ? 'selected' : '' }}>01 - Januari</option>
                                                <option value="02" {{ $currentMonth == '02' ? 'selected' : '' }}>02 - Februari</option>
                                                <option value="03" {{ $currentMonth == '03' ? 'selected' : '' }}>03 - Maret</option>
                                                <option value="04" {{ $currentMonth == '04' ? 'selected' : '' }}>04 - April</option>
                                        ...
                                        <div class="form-group">
                                            <label>File upload</label>
                                            <div style="width: 100%">
                                                <input type="file" name="file_fb" class="form-control" accept=".xlsx" required>
                                                <p style="margin: 0;font-size: 0.8rem;color: #b9b7b7;">Format penamaan file harus : tahunbulanF_kodekabupaten_jagung.xlsx</p>
                                                <p style="margin: 0;font-size: 0.8rem;color: #b9b7b7;">Contoh : 202110F_3301_jagung.xlsx</p>
                                            </div>
                                        </div>
