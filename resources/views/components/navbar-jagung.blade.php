<!-- resources/views/components/navbar.blade.php -->
 <!-- Navbar -->
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start" style ="background-image: url(/assets/img/bg-mode2.png);background-position:top">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch" style ="background-image: url(/assets/img/bg-mode2.png);background-position:top"">
